...
// 王国 (kgd): フランスモデル 攻撃特化 26州 (フランス12 + イベリア10 + 旧中立4: ベネルクス/フランダース/ナバラ/コルシカ)
export const kingdom: NationConfig = {
  ...
  states: [
    ...
    // ---- 旧中立 (v7 で kgd に編入) ----
    { id: "neu_rhine",    name: "ライン回廊", terrain: "plains",    neighbors: ["emp_westmark", "kgd_lorraine", "kgd_burgundy", "kgd_champagne"], straitTo: ["fed_london", "fed_southeast"] },
    { id: "neu_flanders", name: "フランドル", terrain: "coast",     neighbors: ["emp_brabant", "kgd_artois"] },
    { id: "neu_pyrenees", name: "ピレネー",   terrain: "mountains", neighbors: ["kgd_gascony", "kgd_languedoc", "kgd_aragon", "kgd_catalonia", "kgd_basque", "hol_navarre"] },
    { id: "neu_corsica",  name: "コルシカ",   terrain: "coast",     neighbors: [], straitTo: ["rep_genoa", "hol_sardinia", "kgd_provence"] },
  ],
};
